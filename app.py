...
# -----------------------------
# Sidebar: Google Drive Link
# -----------------------------
st.sidebar.header("⚙️ إعدادات الداشبورد")

file_url = st.sidebar.text_input(
    "ضع رابط ملف CSV من Google Drive",
    placeholder="https://drive.google.com/file/d/FILE_ID/view"
)

if file_url == "":
    st.info("الرجاء إدخال رابط Google Drive لملف CSV.")
    st.stop()
...
st.sidebar.code(file_url)

with st.spinner("جاري تحميل البيانات..."):
    df = load_data(file_url, "data.csv")
# -----------------------------
# Sidebar filters
# -----------------------------
st.sidebar.markdown("---")
