...
def load_dashboard_data():
    ...
    try:
        kpis = pd.read_csv(os.path.join(BASE_DIR, "kpis.csv"))
        revenue_by_ad = pd.read_csv(os.path.join(BASE_DIR, "revenue_by_ad.csv"))
        revenue_by_country = pd.read_csv(os.path.join(BASE_DIR, "revenue_by_country.csv"))
        retention = pd.read_csv(os.path.join(BASE_DIR, "retention.csv"))
        anova = pd.read_csv(os.path.join(BASE_DIR, "anova_results.csv"))
        variation_counts = pd.read_csv(os.path.join(BASE_DIR, "variation_counts.csv"))
        sample_preview = pd.read_csv(os.path.join(BASE_DIR, "sample_preview.csv"))

        return kpis, revenue_by_ad, revenue_by_country, retention, anova, variation_counts, sample_preview

    except Exception as e:
        st.error(f"❌ المشكلة: {e}")
        return None
